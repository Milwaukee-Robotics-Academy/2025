...
//  }
  ...
  public static final class DrivebaseConstants
  {
   ...
   public static class Vision {
    ...
    public static final String kCameraNameFront = "Arducam_OV9281_USB_Camera";
    ...
    public static final Transform3d kRobotToCamBack = new Transform3d(
      ...
      new Rotation3d(0, 0, Units.degreesToRadians(-171)));
    public static final Transform3d kRobotToCamFront = new Transform3d(
      new Translation3d(
        Units.inchesToMeters(11.75), 
        Units.inchesToMeters(-9), 
        Units.inchesToMeters(8)),
        new Rotation3d(0, 0, Units.degreesToRadians(17)));
