...
public Command operationNOCommand(){
  return new RunCommand(this::operationNO, this).withName("OperationNO");
}

public Command outtakeCommand(){
  return new RunCommand(this::outtakeCommand, this).withName("Outtake");
}
